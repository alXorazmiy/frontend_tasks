<template>
    <div 
        class="relative bg-[#263040] rounded shadow p-4 cursor-pointer"
        :style="{ 
            width: width + 'px', 
            height: height + 'px', 
            left: position.x + 'px', 
    ...
    >
        ...
        <div class=" absolute top-1 right-1 bg-[#1d2633] flex items-center p-2 rounded-md ccursor-pointer" @click = "$emit('close-chart')" >
...
<script setup>
    ...
    import { Chart as ChartJS, Title, Tooltip, Legend, CategoryScale,PointElement, LineElement, LinearScale, RadialLinearScale } from 'chart.js'
    ChartJS.register(Title, Tooltip, Legend, CategoryScale, PointElement, LineElement, LinearScale, RadialLinearScale)
